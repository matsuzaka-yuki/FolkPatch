...
import me.yuki.folk.APApplication.Companion.SUPERCMD
...
fun listModules(): String {
    ...
    withNewRootShell{
       newJob().add("cp /data/user/*/me.yuki.folk/patch/ori.img /data/adb/ap/ && rm /data/user/*/me.yuki.folk/patch/ori.img")
