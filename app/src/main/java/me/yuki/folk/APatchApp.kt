...
import me.yuki.folk.ui.CrashHandleActivity
...
import me.yuki.folk.util.Version
import me.yuki.folk.util.getRootShell
import me.yuki.folk.util.rootShellForResult
import me.yuki.folk.util.verifyAppSignature
...
class APApplication : Application(), Thread.UncaughtExceptionHandler, ImageLoaderFactory {
    ...
    override fun onCreate() {
        ...
        me.yuki.folk.util.LauncherIconUtils.applySaved(this, sharedPreferences.getString("launcher_icon_variant", "default"))
