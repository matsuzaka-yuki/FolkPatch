...
import me.yuki.folk.ui.component.FilePickerDialog
...
import me.yuki.folk.BuildConfig
import me.yuki.folk.Natives
import me.yuki.folk.R
import me.yuki.folk.ui.component.SettingsCategory
import me.yuki.folk.ui.component.SwitchItem
import me.yuki.folk.ui.component.rememberConfirmDialog
import me.yuki.folk.ui.component.rememberLoadingDialog
import me.yuki.folk.ui.theme.BackgroundConfig
import me.yuki.folk.ui.theme.BackgroundManager
import me.yuki.folk.ui.theme.FontConfig
import me.yuki.folk.ui.theme.ThemeManager
import me.yuki.folk.ui.theme.refreshTheme
import me.yuki.folk.util.APatchKeyHelper
import me.yuki.folk.util.PermissionRequestHandler
import me.yuki.folk.util.PermissionUtils
import me.yuki.folk.util.getBugreportFile
import me.yuki.folk.util.isForceUsingOverlayFS
import me.yuki.folk.util.isGlobalNamespaceEnabled
import me.yuki.folk.util.isLiteModeEnabled
import me.yuki.folk.util.outputStream
import me.yuki.folk.util.overlayFsAvailable
import me.yuki.folk.util.rootShellForResult
import me.yuki.folk.util.setForceUsingOverlayFS
import me.yuki.folk.util.setGlobalNamespaceEnabled
import me.yuki.folk.util.setLiteMode
import me.yuki.folk.util.ui.APDialogBlurBehindUtils
import me.yuki.folk.util.ui.LocalSnackbarHost
import me.yuki.folk.util.ui.NavigationBarsSpacer
import java.time.LocalDateTime
import java.time.format.DateTimeFormatter
import java.util.Locale

import me.yuki.folk.ui.theme.MusicConfig
import me.yuki.folk.util.MusicManager
...
fun SettingScreen(navigator: DestinationsNavigator) {
    ...
    Scaffold(
        ...
        Column(
            ...
            val currentDpiVal = me.yuki.folk.util.DPIUtils.currentDpi
...
fun DpiChooseDialog(showDialog: MutableState<Boolean>) {
    ...
    BasicAlertDialog(
        ...
        Surface(
            ...
            LazyColumn {
                items(me.yuki.folk.util.DPIUtils.presets) { preset ->
                    ListItem(
                        headlineContent = { Text(text = preset.name) },
                        modifier = Modifier.clickable {
                            showDialog.value = false
                            me.yuki.folk.util.DPIUtils.setDpi(context, preset.value)
                ...
                items(iconPresetList()) { preset ->
                    ListItem(
                        ...
                        modifier = Modifier.clickable {
                            ...
                            me.yuki.folk.util.LauncherIconUtils.applySaved(context, preset.name)
                        })
                }
            }
