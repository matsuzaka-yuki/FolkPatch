...
jobject nativeSuProfile(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jint uid) {
    ...
    jclass cls = env->FindClass("me/yuki/folk/Natives$Profile");
...
jobject nativeControlKernelPatchModule(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jstring module_name_jstr, jstring control_args_jstr) {
    ...
    jclass cls = env->FindClass("me/yuki/folk/Natives$KPMCtlRes");
    jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void * /*reserved*/) {
    ...
    auto clazz = JNI_FindClass(env, "me/yuki/folk/Natives");
    ...
    const static JNINativeMethod gMethods[] = {
        ...
        {"nativeSuProfile", "(Ljava/lang/String;I)Lme/yuki/folk/Natives$Profile;", reinterpret_cast<void *>(&nativeSuProfile)},
        ...
        {"nativeControlKernelPatchModule", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lme/yuki/folk/Natives$KPMCtlRes;", reinterpret_cast<void *>(&nativeControlKernelPatchModule)},
